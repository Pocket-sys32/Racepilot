...
THROTTLE_COLORS = [
  rl.Color(0, 255, 255, 102),
  rl.Color(0, 255, 255, 89),
  rl.Color(0, 255, 255, 0),
]
...
LANE_LINE_COLORS = {
  ...
  UIStatus.ENGAGED: rl.Color(0, 255, 255, 255),
}
...
class ModelRenderer(Widget):
  ...
  def _update_track_path(self):
    ...
    self._track_path.projected_points = self._map_line_to_polygon(
      self._track_path.raw_points, 0.35, self._path_offset_z, max_idx, allow_invert=False
    )
