...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"GameActive", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL}},
    {"GameHighScoreDoom", {PERSISTENT, INT, "0"}},
    ...
    {"TicTacToeWins", {PERSISTENT, INT, "0"}},
    {"TrackMode", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL}},
    {"TrackModeConfig", {PERSISTENT, JSON}},
    ...
    {"SupabaseAnonKey", {PERSISTENT | DONT_LOG, STRING}},
    {"SupabaseUrl", {PERSISTENT, STRING}},
